...
if __name__ == "__main__":
    ...
    try:
        silhouette_result = compute_silhouette_score(labels, umap_embedding, metric='euclidean')
    ...
    # Test DBCV score
    try:
        dbcv_score = compute_dbcv_score(labels, original_embeddings, metric='euclidean')
